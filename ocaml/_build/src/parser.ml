...
# 637 "src/parser.ml"
    ...
    | MenhirState69 | MenhirState67 | MenhirState62 | MenhirState65 | MenhirState59 | MenhirState61 | MenhirState54 | MenhirState56 | MenhirState58 | MenhirState53 | MenhirState52 | MenhirState41 | MenhirState49 | MenhirState51 | MenhirState43 | MenhirState47 | MenhirState45 | MenhirState40 ->
        let _menhir_stack = Obj.magic _menhir_stack in
        assert (not _menhir_env._menhir_error);
        let _tok = _menhir_env._menhir_token in
        (match _tok with
